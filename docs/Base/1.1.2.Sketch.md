...
Os detalhes sobre o processo de desenvolvimento deste 5W2H, incluindo uma explicação do método e a metodologia utilizada, estão documentados no tópico [1.2.3. 5W2H](/Base/1.2.3.5W2H.md). A partir deste tópico, será possível compreender as ideias utilizadas para a construção do artefato, de maneira a incluir os pontos principais escolhidos a serem trabalhados no projeto.
